...
* Граждане, у которых нет одобрения ЦЗН, могут выбрать поток,  дата начала которого не раньше, чем через 4 рабочих дней от текущей даты.
...
Как только ваша заявка попадет на шаг 8, вы получите письмо- приглашение в Odin и сможете войти на платформу, где будет проходить обучение. Вход допустим по логину - адрес электронной почты, указанный при подаче заявки и паролю (инструкция по установке пароля также придет в письме приглашении с адреса noreply@odin.study).&#x20;
...
На этом шаге вы сможете войти на образовательную сразу из ЛК гражданина, познакомиться с системой, где проводит обучение ваша образовательная организация, и приступить к нему.
