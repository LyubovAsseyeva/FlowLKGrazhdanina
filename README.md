...
{% hint style="warning" %}
На этом шаге в личном кабинете у вас пропадёт кнопка "Отменить заявку"(будет заменена на кнопку "Заявление на отчисление"), и если по каким-то причинам вы не хотите продолжать обучение, необходимо будет написать в университет **заявление на отчисление по собственному желанию**.
{% endhint %}
...
Шаг 11 находится в работе.\
Заполнить информацию о резюме вы можете пока на панели справа. После отправки резюме дополнительных действий не требуется. Оно будет сохранено автоматически. Просмотр резюме будет доступен после доработки шага 11. &#x20;
