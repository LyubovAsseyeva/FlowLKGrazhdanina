...
Для перехода **к следюущему этапу**  необходимо дождаться, когда все загруженные документы проверит представитель вашей образовательной организации, и вы **получите  подтверждение ЦЗН о том, что ваша заявка одобрена.**&#x20;
...
Вы можете приступить к обучению. Обучение будет проходить на платформе [Odin](http://127.0.0.1:5000/s/WRKfIWXs8CN7zTlPN8M4/). &#x20;
...
Данный этап будет открыт за 14 календарных дней до момента окончания обучения.
...
Также следует добавить документ о занятости.

<figure><img src=".gitbook/assets/image (8).png" alt=""><figcaption></figcaption></figure>

Также, заполнение Резюме доступно в правом блоке.&#x20;
